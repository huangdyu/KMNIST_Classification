...
if __name__ == '__main__':
    ...
    parser.add_argument('-aug', action = 'store_true', default = False, help = 'Doing augmentation on test set or not')
    parser.add_argument('-name1', type = str, default = 'test1.jpg', help = 'the file name to save the fig results')
    parser.add_argument('-name2', type = str, default = 'test2.jpg', help = 'the file name to save the fig results (using augmentation)')
